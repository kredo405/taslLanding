                ...
                <table className="w-full h-full table-auto text-sm text-left">
                    <thead className="dark:text-gray-50 text-gray-600 font-medium border-b dark:border-slate-700">
                        <tr>
                            ...
                            <th className="py-3 px-6">Лайки</th>
                            <th className="py-3 px-6">Дизлайки</th>
                        </tr>
                    </thead>
                    <tbody className="text-gray-600 divide-y">
                        {
                            data.map((item, idx) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 dark:text-gray-50 py-4 whitespace-nowrap">{item.complexity}</td>
                                    <td className="px-6 dark:text-gray-50 py-4 whitespace-nowrap">
                                        <div className="flex">
                                            {item.rate}
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="text-cyan-500 ml-2 w-6 h-6">
                                    ...
                                    <td className="px-6 dark:text-gray-50 py-4 whitespace-nowrap">
                                        <div className="flex">
                                            {item.rate}
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="text-orange-400 ml-2 w-6 h-6">
