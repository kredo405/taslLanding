...
const items = [
    {
        ...
        children: <div className="h-24 dark:bg-slate-700 bg-slate-100 text-center dark:text-gray-50 font-bold text-xl">Тут будет Условие</div>,
    },
    {
        key: '2',
...
const Simulator = () => {
    ...
    return (
        <>
            <Nav />
            <div className={`flex justify-between  px-2 lg:px-10 mt-10 h-screen`}>
                <div className="w-full flex flex-col border-r-2 border-none border-zinc-400 dark:border-slate-700 lg:border-solid">
                    <div className="flex justify-center">
                        <h1 className="font-serif text-center dark:text-gray-50 text-2xl font-bold">{task.task}</h1>
                    </div>
                    <div className="mt-1 flex flex-col items-center justify-center sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
                        <div className="mt-2 flex items-center text-sm text-gray-500 dark:text-gray-50">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 px-2 text-gray-600 dark:text-gray-50">
                    ...
                    <div className="max-w-md mx-auto px-4 mt-5">
                        <h2 className="text-gray-800 font-medium text-center dark:text-gray-50">Задача выполнена когда:</h2>
                        <ul className="mt-3 space-y-3">
                            {
                                radios.map((item, idx) => (
                                    <li key={idx} className="flex items-center gap-x-2.5">
                                        <input type="checkbox" name="role" id={idx} className="form-radio border-gray-400 text-indigo-600 focus:ring-indigo-600 duration-150" />
                                        <label htmlFor={idx} className="text-sm text-gray-700 dark:text-gray-50 font-medium">
                                            {item}
                                        </label>
                                    </li>
                                ))
                ...
                <div className={`hidden lg:block w-full border-t-2 border-slate-700 border-solid`}>
                    <div className="flex justify-center my-3">
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 bg-lime-600">
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 bg-orange-500">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M3 3v1.5M3 21v-6m0 0l2.77-.693a9 9 0 016.208.682l.108.054a9 9 0 006.086.71l3.114-.732a48.524 48.524 0 01-.005-10.499l-3.11.732a9 9 0 01-6.085-.711l-.108-.054a9 9 0 00-6.208-.682L3 4.5M3 15V4.5" />
                            </svg>
                        </button>
                    </div>
                    <div className="px-3">
                        <Editor height="49vh" defaultLanguage="java" theme='vs-dark' defaultValue='class HelloWorld {
                    ...
                    <div className="border-y-2 border-slate-600 border-solid mt-2 mx-0">
                        <span className="px-3 font-bold py-2 dark:text-gray-50">Вывод:</span>
                    </div>
                </div>
                            ...
                            <div className="flex items-center min-h-screen px-4 py-8">
                                <div className="relative w-full max-w-lg mx-auto bg-white rounded-md shadow-lg">
                                    ...
                                    <div className="space-y-2 p-4 mt-3 text-[15.5px] leading-relaxed text-gray-500">
                                        <div className={` w-full border-t-2 border-slate-700 border-solid`}>
                                            <div className="flex justify-center my-3">
                                                <button
                                                    type="button"
                                                    className="inline-flex mx-2 items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
